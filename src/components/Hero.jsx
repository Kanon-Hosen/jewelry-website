...
const Hero = () => {
  ...
  return (
    <div className="carousel w-full py-10 md:py-0 md:h-[510px] mt-6">
      <div id="slide1" className="carousel-item relative w-full">
      <div className="flex md:flex-row flex-col-reverse items-center gap-9 justify-between">
                  <div className="md:w-1/2 text-left" data-aos="fade-left" data-aos-duration="2000">
                      <p className="text-left mb-2">Shop Latest Design</p>
                      <h1 className="font-semibold text-3xl md:text-5xl capitalize text-left leading-normal text-white" >Shop for daimond <br></br> silver rings</h1>
        ...
        <div className="absolute flex justify-between md:justify-start gap-3 transform -translate-y-1/2 left-0 right-0 md:bottom-10 md:top-auto  top-1/2" data-aos="fade-right" data-aos-duration="1000">
      ...
      <div className="flex md:flex-row flex-col-reverse items-center gap-9 justify-between">
                  <div className="md:w-1/2 text-left" data-aos="fade-left" data-aos-duration="2000">
                      <p className="text-left mb-2">Shop Latest Design</p>
                      <h1 className="font-semibold text-3xl md:text-5xl capitalize text-left leading-normal text-white" >For Designer silver <br></br>Earring Sets</h1>
        ...
        <div className="absolute flex justify-between md:justify-start gap-3 transform -translate-y-1/2 left-0 right-0 md:bottom-10 md:top-auto  top-1/2">
